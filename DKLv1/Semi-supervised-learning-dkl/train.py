...
def get_config():
    ...
    # ikl consistency loss
    parser.add_argument("--consistency_loss_type", type=str, default=None)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    print(torch.randn(2,4), " pytorch random 11111111111111111111")
    print(np.random.randn(2,4), " numpy random 1111111111111111111")
    print(random.randint(2,4), " python random 11111111111111111")
    print(np.random.uniform(32), " numpy random uniform 1111111111111111111")
