...
parser.add_argument('--T2', default=100.0, type=float, help='for ikl')
...
def train(train_loader, model, criterion, optimizer, epoch, scaler, args, model_fixed=None, CLASS_PRIORS=None):
    ...
    if args.distill and args.distill_loss == "IKL_KD":
        ...
        if not args.fp16:
           ...
           if args.distill:
               ...
               if args.distill_loss == 'IKL_KD':
                   ...
                   loss += dkl_loss(logits, logits_k, args.temperature, args.alpha, args.beta, CLASS_PRIOR=CLASS_PRIOR, GI=args.GI, T2=args.T2)
