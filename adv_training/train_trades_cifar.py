...
##
parser.add_argument('--robust_arch', type=str, default='WideResNet')
parser.add_argument('--nat_arch', type=str, default='ResNet18_cifar')
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs + 1):
        ...
        adv_loss, adv_acc = train(model, train_loader, optimizer, epoch, awp_adversary, start_wa, tau_list, exp_avgs)
